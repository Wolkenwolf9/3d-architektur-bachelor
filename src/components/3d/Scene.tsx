...
import PanoramaNav from '../ui/PanoramaNav';
    ...
    <div className='relative w-full h-screen'>
      ...
      {in360 && (
        <PanoramaNav
          ...
          onSelect={setActivePanorama}
        />
      )}
      {/* Funktion nicht Sinnvoll */}
      {/* <button
      ...
      {/* //Slider um Komponenten ein/aus zu togglen */}
      ...
      <SceneControls
        ...
        onToggleOpen={() => setShowControlsMenu((state) => !state)}
        showArrows={showArrows}
        setShowArrows={setShowArrows}
        showVirtualStudio={showVirtualStudio}
        setShowVirtualStudio={setShowVirtualStudio}
        showAufzüge={showAufzüge}
        setShowAufzüge={setShowAufzüge}
        showMensa={showMensa}
        setShowMensa={setShowMensa}
        showBib={showBib}
        setShowBib={setShowBib}
        showCameraDebug={showCameraDebug}
        setShowCameraDebug={setShowCameraDebug}
      />
    </div>
  );
}
